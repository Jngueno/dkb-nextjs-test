...
export default function Header(props: any): JSX.Element {
    const changeHandler = (event: any) => {
        ...
        setTimeout(() => {
            searchApi(event.target.value).then(res => {
                props.setResults(res.data.movies)
        ...
        <div className="h-20 shadow-lg w-full fixed z-10 px-4 border-black border-b-2 bg-[#acacac]">
            <div className="flex items-center h-20 w-full mx-auto justify-between container">
                ...
                <label htmlFor="search" className="flex items-center gap-1">
                    ...
                    <input onChange={changeHandler} type="search" name="search" id="search" className="px-4 py-2 msm:py-1 msm:px-2 text-sm sm:text-lg italic font-bold border-2 border-black bg-[#acacac] focus:border-gray-300 focus:outline-none" />
                </label>
            </div>
        </div>
